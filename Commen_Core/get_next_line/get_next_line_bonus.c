...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/17 18:02:19 by zwina             #+#    #+#             */
/*   Updated: 2022/01/07 17:56:32 by zwina            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (!(holy_str[fd]))
		holy_str[fd] = ft_strdup("");
	get_current_line(fd, &(holy_str[fd]), &line, &buff);
	return (line);
}
